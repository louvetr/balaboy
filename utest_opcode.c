...
struct opcode_info opcode_dict[8] = {
...
{
	printf("[REGS]  A=0x%X,     B=0x%X,    C=0x%X,    D=0x%X,    E=0x%X,    F=0x%X\n",
...
static int print_cpu_test_result(struct opcode_info op_info, int fail_condition,
